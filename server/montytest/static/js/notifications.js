...
const montytestFollowLock = "montytest_follow_lock";
...
function notifymontytest_(message) {
...
function notifymontytest(message) {
  broadcast("notifymontytest_", message);
}
...
async function followRun(runId) {
  if (navigator.locks) {
    return navigator.locks.request(montytestFollowLock, async (lock) => {
...
broadcastDispatch["notifymontytest_"] = notifymontytest_;
...
function cleanup_() {
  ...
  localStorage.removeItem("montytest_disable_notification");
  localStorage.removeItem("montytest_notifications");
  localStorage.removeItem("montytest_notifications_v2");
  localStorage.removeItem("montytest_timestamp");
  localStorage.removeItem("montytest_timestamp_purge");
  localStorage.removeItem("__montytest__latest_purge_time");
  localStorage.removeItem("__montytest__latest_fetch_time_sig");
  localStorage.removeItem("__montytest__latest_fetch_time");
}
