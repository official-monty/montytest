...
function chi2_95(df) {
  ...
  const chi2_95_ = [
    ...
    18.307038053275143, 19.675137572682491, 21.026069817483066,
    22.362032494826941, 23.68479130484058, 24.99579013972863,
    26.296227604864235, 27.587111638275324, 28.869299430392626,
    30.143527205646159, 31.410432844230929, 32.670573340917294,
    33.9244384714438, 35.17246162690806, 36.415028501807299, 37.652484133482766,
    38.885138659830055, 40.113272069413611, 41.337138151427411,
    42.556967804292668, 43.772971825742182, 44.985343280365129,
    46.194259520278457, 47.399883919080921, 48.602367367294178,
    49.801849568201824, 50.99846016571064, 52.192319730102874,
    53.383540622969278, 54.572227758941736, 55.758479278887037,
    56.942387146824075, 58.124037680867971, 59.303512026899838,
    60.480886582336431, 61.656233376279538, 62.829620411408186,
    64.001111972218013, 65.170768903569808, 66.338648862968768,
    67.5048065495412, 68.669293912285838, 69.832160339848173,
    70.993452833782186, 72.153216167023089, 73.311493029083195,
    74.46832415930939, 75.623748469376167, 76.777803156061395,
    77.930523805230379, 79.081944487848745, 80.232097848762848,
    81.381015188899141, 82.528726541471897, 83.675260742721008,
    84.820645497656727, 85.964907441231006, 87.108072195321995,
    88.250164421874018, 89.391207872507835, 90.531225434880668,
    91.670239176054821, 92.808270383107839, 93.945339601192217,
    95.081466669243298, 96.216670753503891, 97.350970379033186,
    98.484383459340307, 99.616927324283921, 100.74861874635026,
    101.87947396543589, 103.00950871222616, 104.13873823027392,
    105.26717729686055, 106.39484024272251, 107.52174097071949,
    108.64789297350764, 109.77330935028799, 110.89800282268439,
    112.02198574980785, 113.1452701425555, 114.26786767719352,
    115.38978970826668, 116.51104728087367, 117.63165114234559,
...
const spsa_setup_default = {
  ...
  lambda_ratio: 3,
  params: [
    { name: "dummy", start: 50, min: 0, max: 100, elo: 2, c: null, r: null },
  ],
  num_games: null,
};
...
function tcToSeconds(tc) {
  ...
  */
  let inc = 0;
  let moves = 68; /* montytest average LTC game duration. */
  let time;
  let chunks = tc.split("+");
  if (chunks.length > 2) {
    return null;
...
/*
Now some code to convert montytest style spsa data to spsa_setup
objects and back.
*/

function montytestToSpsa(fs) {
