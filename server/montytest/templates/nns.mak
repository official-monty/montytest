...
<script>
  document.title = "Neural Network Repository | Monty Testing";
</script>
...
<p>
  ...
  <a href="https://github.com/official-monty/Monty/blob/master/Copying.txt">GPLv3</a> license.<br><br>
  Nets colored <span class="default-net">green</span> in the table have passed montytest testing
  and achieved the status of <i>default net</i> during the development of Monty.<br><br>
  The recommended net for a given Monty executable can be found as the default value of the PolicyFile / ValueFile option.
</p>
