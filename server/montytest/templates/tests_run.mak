...
<%!
  from montytest.util import format_bounds
...
<script>
  document.title = "Create New Test | Monty Testing";
</script>
            ...
            <div class="row gx-1">
              ...
              <div class="mb-2">
                ...
                <input
                  ...
                  placeholder="https://github.com/username/Monty"
                >
              </div>
                  ...
                  <div class="modal-dialog modal-dialog-scrollable">
                    <div class="modal-content">
                      ...
                      <div class="modal-body text-break">
                        ...
                        code in Monty in such a way that the SPSA tune will finish within 0.5 Elo
      ...
      if (!isRun) {
          if (isDatagen) {
            ...
            if(document.getElementById("threads").readOnly)
            {
                ...
                document.getElementById("new-options").value = "${args.get('new_options', 'Hash=16')}";
                document.getElementById("new-options").readOnly = false;
                document.getElementById("base-options").value = "${args.get('base_options', 'Hash=16')}";
