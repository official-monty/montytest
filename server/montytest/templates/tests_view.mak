...
<div id="enclosure"${' style="visibility:hidden;"' if show_task >= 0 else "" |n}>
  ...
  <div class="row">
    ...
    <div class="col-12 col-lg-3">
      ...
      % if 'spsa' not in run['args'] and run['args'].get('base_options', 'Hash=32').replace(" ", "") != run['args'].get('new_options', 'Hash=32').replace(" ", ""):
          <div class="alert alert-danger mb-2">
...
<script>
  document.title = "${page_title} | Monty Testing";
