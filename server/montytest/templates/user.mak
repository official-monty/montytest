...
<%!
  from montytest.util import format_group
%>

% if profile:
  <script>
    document.title = "Profile | Monty Testing";
...
% else:
  <script>
    document.title = "User Management | Monty Testing";
  </script>
% endif
      ...
      <ul class="list-group list-group-flush">
        ...
        % if not profile:
          ...
          <li class="list-group-item bg-transparent text-break">Email: 
            <a href="mailto:${user['email']}?Subject=Montytest%20Account" class="alert-link">
              ${user['email']}
            </a>
          </li>
        % endif
      ...
      <div class="input-group mb-3">
        <div class="form-floating">
          <input
            ...
            placeholder="GitHub Monty fork URL"
          >
