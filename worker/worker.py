...
LOGO = r"""
  __  __             _                              _             
 |  \/  | ___  _ __ | |_ _   _  __      _____  _ __| | _____ _ __ 
 | |\/| |/ _ \| '_ \| __| | | | \ \ /\ / / _ \| '__| |/ / _ \ '__|
 | |  | | (_) | | | | |_| |_| |  \ V  V / (_) | |  |   <  __/ |   
 |_|  |_|\___/|_| |_|\__|\__, |   \_/\_/ \___/|_|  |_|\_\___|_|   
                         |___/                                    
"""
...
def setup_fastchess(worker_dir, compiler, concurrency, global_cache):
    ...
    try:
        ...
        cmds = [
            f"make -j{concurrency} tests CXX=g++ GIT_SHA={fastchess_sha[0:8]} GIT_DATE=01010101",
            str(tmp_dir / prefix / ("fastchess-tests" + EXE_SUFFIX)),
            "make clean",
            f"make -j{concurrency} CXX=g++ GIT_SHA={fastchess_sha[0:8]} GIT_DATE=01010101",
        ]
